	...
	var ImageMapHighlighter = function () {
	    ...
	    _createClass(ImageMapHighlighter, [{
	        ...
	        value: function _drawHighlightByArea(canvas, area) {
	            ...
	            this._drawHighlight(canvas, shape, coords, area);
	        }
	        ...
	        key: '_drawHighlight',
	        value: function _drawHighlight(canvas, shape, coords, area = null) {
	            var context = canvas.getContext('2d');
	            ...
	            switch (shape) {
	                ...
	                case 'poly':
                        if(area && area.src) {
                            let img = document.querySelector("[src='"+ area.src + "']")
							context.drawImage(img, 0, 0, this.element.width, this.element.height);
                        } else {
