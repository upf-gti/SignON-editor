...
class TransformControlsGizmo extends Object3D {
	...
	constructor() {
		...
		matRed.color.setHex( 0xff6969 );

		const matGreen = gizmoMaterial.clone();
		matGreen.color.setHex( 0x69ff69 );

		const matBlue = gizmoMaterial.clone();
		matBlue.color.setHex( 0x6969ff );

		const matRedTransparent = gizmoMaterial.clone();
		matRedTransparent.color.setHex( 0xff6969 );
		matRedTransparent.opacity = 0.5;

		const matGreenTransparent = gizmoMaterial.clone();
		matGreenTransparent.color.setHex( 0x69ff69 );
		matGreenTransparent.opacity = 0.5;

		const matBlueTransparent = gizmoMaterial.clone();
		matBlueTransparent.color.setHex( 0x6969ff );
		...
		matYellowTransparent.color.setHex( 0xffff69 );
		matYellowTransparent.opacity = 0.25;

		const matYellow = gizmoMaterial.clone();
		matYellow.color.setHex( 0xffff69 );
		...
		const arrowGeometry = new CylinderGeometry( 0, 0.035, 0.1, 12 );
		arrowGeometry.translate( 0, 0.05, 0 );

		const scaleHandleGeometry = new BoxGeometry( 0.06, 0.06, 0.06 );
